...
op3 = teamlabs.opportunities.create(title:'Digital Marketing', description:'Ut enim ad minim veniam, quis nostrud exercitation ullamco.', opportunity_type:'Workshop', startdate:DateTime.new(2016,7,25), duration:'2 days', location:'Carrer Bailén 11, Barcelona', published:true)
